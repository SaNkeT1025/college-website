...
<body style="height:calc(100vh);background-image:url(../../images/p5-dark.jpg);background-size:cover;background-attachment: fixed;">
            ...
            <div style="padding-left: 1%;" class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav items ">
                        ...
                        <a class="nav-link active" style="padding-left: 7%;" href="./arrivedrequest.php">Requests</a>
                        <a class="nav-link" style="padding-left: 7%;" href="./friends.php">Friends</a>                    </div>
                </div>
        ...
        <?php
            ...
            $query = "UPDATE requests SET read_status=1 where friendid='$sprn'";
            $result = $connection->query($query);
            $query = "SELECT * from student where prn in(select user from requests where friendid='$sprn' and status='pending')";
            $result = $connection->query($query);
            ?>
                <div style="width: 94%;margin-left: 3%;margin-top: 2%;">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-success" onclick="window.location.href='./requestaccept.php?id=<?php echo $pprn;?>'">Accept</button>
                                <button class="btn btn-danger" onclick="window.location.href='./requestdecline.php?id=<?php echo $pprn;?>'">Decline</button>
                            </td>
                        </tr>
                <?php
                        }
            ...
            <?php
                $query = "SELECT * from faculty where facultyid in(select user from requests where friendid='$sprn' and status='pending')";
                $result = $connection->query($query);
            ?>
            ...
            <table id="myTable" style="width: 90%;margin-left: 5%;background: white;">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $pclass?></td>
                            <td>
                                <button class="btn btn-success" onclick="window.location.href='./requestaccept.php?id=<?php echo $facultyid;?>'">Accept</button>
                                <button class="btn btn-danger" onclick="window.location.href='./requestdecline.php?id=<?php echo $facultyid;?>'">Decline</button>
                            </td>
                        </tr>
                <?php
                        }
