...
<body style="height:calc(100vh);background-image:url(../../images/p5-dark.jpg);background-size:cover;background-attachment: fixed;">
            ...
            <div style="padding-left: 1%;" class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav items ">
                        ...
                        <a class="nav-link active" style="padding-left: 7%;" href="./friends.php">Friends</a>
                    </div>
        ...
        <?php
            ...
            $query = "SELECT * from student where prn in(select friendid from requests where user='$sprn' and status='accepted')";
            ...
            ?>
                <div style="width: 94%;margin-left: 3%;margin-top: 2%;">
                    ...
                    <tbody id='myBody'>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" onclick="window.location.href='viewprofile.php?id=<?php echo $pprn?>'">View Profile</button>
                                <button class="btn btn-warning" onclick="window.location.href='unfriend.php?id=<?php echo $pprn?>'">Unfriend</button>
                            </td>
                        </tr>
                    </tbody>
                <?php
                ...
                else
                {
                    ?>
                <tr>
                    <td colspan="7">No Friends Yet</td>
                </tr>
                <?php
                }
            ?>
            ...
            <?php
                $query = "SELECT * from faculty where facultyid in(select friendid from requests where user='$sprn' and status='accepted')";
                $result = $connection->query($query);
            ?>
            ...
            <table id="myTable" style="width: 90%;margin-left: 5%;background: white;">
                    ...
                    <tbody id='myBody'>
                        <tr>
                            ...
                            <td><?php echo $pclass?></td>
                            <td>
                                <button class="btn btn-primary" onclick="window.location.href='../../faculty/friend/facultyProfileView.php?id=<?php echo $facultyid?>'">View Profile</button>
                                <button class="btn btn-warning" onclick="window.location.href='unfriend.php?id=<?php echo $facultyid?>'">Unfriend</button>
                            </td>
                        </tr>
                    </tbody>
                <?php
