...
<h3 style="background: black;
    ...
    width: 94%;
    margin-left: 3%;
    margin-top: 1%;" class="text-center text-white">Manage Faculty <button style="float: right;margin-right: 1%;"  class="btn btn-warning" onclick="window.location.href='./home.php'">Dashboard</button></h3>
    ...
    <div style="width: 94%;margin-left: 3%;">
        <table id="myTable" >
            ...
            <tr>
                ...
                <td><button onclick="window.location.href='delete.php?id=<?php echo $row['facultyid'].' '.'faculty'?>'" type="button" class="btn btn-danger">Delete</button></td>
            </tr>
