...
<body>
    ...
    width: 94%;
    margin-left: 3%;
    margin-top: 1%;" class="text-center text-white">Student Approval Requests <button
...
if ($conn->connect_error) {
    ...
    $sql = "SELECT * FROM `student` WHERE STATUS='not approved'"  ;
...
<div style="width: 94%;margin-left: 3%;">
    <table id="myTable">
        ...
        <tr>
            ...
            <td><?php echo $name ?></td>
            <td>
                <button onclick="window.location.href='accept.php?id=<?php echo $row['prn']?>'" type="button"
                    class="btn btn-primary" style="margin-left: 20%;">Approve</button>
                <button onclick="window.location.href='decline.php?id=<?php echo $row['prn']?>'" type="button"
                    class="btn btn-danger">Decline</button>
                <input class="btn btn-success view_data" type="button" name="view" value="Details"
                    id="<?php echo $row["prn"]; ?>" style="width: 19%;">
            </td>
        </tr>
