...
<body>
    ...
    width: 94%;
    margin-left: 3%;
    margin-top: 1%;" class="text-center text-white">Notes Details<button style="float: right;margin-right: 1%;"
    ...
    $sql = "SELECT * FROM notes where `sentby`='$facultyid'";
...
echo "<table id=\"myTable\" class='table'<tr><th>id</th><th>File Name</th><th >For Class</th><th>Action</th><th>Operation</th></tr>";
...
echo "<td><button><a href=\"../student/notes/$file[pdf]\">View Notes</a></button></td>";
echo " <td>
