...
<body>
    ...
    width: 94%;
    margin-left: 3%;
    margin-top: 1%;" class="text-center text-white">Timetable Details<button style="float: right;margin-right: 1%;"
...
echo "<table id=\"myTable\" class='table'<tr><th>File Name</th><th >For Class</th><th>Action</th><th>Operation</th></tr>";
...
echo "<td><button><a href=\"../student/timetable/$file[pdf]\">View Timetable</a></button></td>";
echo " <td>
