...
<body style="height:calc(100vh);background-image:url(../../images/p5-dark.jpg);background-size:cover;background-attachment: fixed;">
        ...
        <?php
            ...
            $query = "SELECT * from faculty where facultyid in(select friendid from requests where user='$id' and status='accepted')";
            $result = $connection->query($query);
            ?>
                <div style="width: 94%;margin-left: 3%;margin-top: 2%;">
                    ...
                    <tbody id='myBody'>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" onclick="window.location.href='facultyProfileView.php?id=<?php echo $facultyid?>'">View Profile</button>
            ...
            <?php
                $query = "SELECT * from student where prn in(select friendid from requests where user='$id' and status='accepted')";
                $result = $connection->query($query);
            ?>
