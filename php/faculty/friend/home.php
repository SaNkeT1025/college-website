...
<body style="height:calc(100vh);background-image:url(../../images/p5-dark.jpg);background-size:cover;background-attachment: fixed;">
        ...
        <?php
            ...
            $query = "SELECT * from faculty where facultyid!='$id' and facultyid not in(select friendid from requests where USER='$id')";
            $result = $connection->query($query);
        ?>
        ...
        <?php
            ...
            <?php
                $query = "SELECT * from student where prn not in(select friendid from requests where USER='$id')";
                $result = $connection->query($query);
            ?>
